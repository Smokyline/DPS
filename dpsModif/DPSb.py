...
def update_data(data):
    ...
    #A = data[:2500]
    A = read_csv('/Users/Ivan/Documents/workspace/resourses/csv/geop/kvz/kvz_5-7.csv').T
...
SpData = read_csv('/Users/Ivan/Documents/workspace/resourses/csv/geop/kvz/kvz_dps3.csv').T
#data = toDesc(SpData)
data = SpData
