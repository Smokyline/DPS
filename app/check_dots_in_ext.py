...
eq_coord = read_csv(workspace_path+'resources/csv/geop/altaiSay/altaiSay_3,5.csv').T
ext_coord = read_csv(workspace_path+'resources/csv/geop/altaiSay/ext_dze.csv').T
